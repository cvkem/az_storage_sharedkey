...
const KEY_B64: &str = "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==";
...
impl AuthHeader {
    ...
    let signed = hmac_sha256::get_hmac_b64(KEY_B64, &to_sign);
    ...
    pub fn set_store_account(mut self, store_account: String) -> Self {
